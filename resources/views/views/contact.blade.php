...
{{-- <!-- Script para mostrar el modal con errores -->
<script>
    $(document).ready(function() {
        // Verificar si hay errores en la sesión (por redireccionamiento)
        @if($errors->any())
            $('#errorModal').modal('show'); // Mostrar el modal si hay errores
        @endif
    });
</script>
    ...
    <div class="col-lg-8 mb-5">
        ...
        @endif
                                                      ...
                                                      <div class="alert alert-danger">
                                                          <strong>{{ $errors->first('error with inputs') }}</strong>
                                                          <ul>
                                                              @foreach ($errors->all() as $error)
                                                                  <li>{{ $error }}</li>
                                                              @endforeach
          ...
          <div class="col-lg-8 mb-5" >
            ...
            <form action="{{ route('contact.store') }}" method="POST" class="needs-validation" novalidate>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <input type="number" class="form-control" id="telefono" name="telefono" placeholder="Telefono" required maxlength="12" >
                      @error("telefono")
                      <p><strong>{{$message}}</strong></p>
                      @enderror
                  </div>
      ...
      <!-- Incluir jQuery y Bootstrap (si los estás usando) en tu vista -->
