...
<head>
    ...
    <link href="{{ asset('css/css1/bootstrap.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('css/css1/sign-in.css') }}" rel="stylesheet">
  </head>
...
<main class="form-signin w-100 m-auto">
  <form>
    <h1 class="h3 mb-3 fw-normal">Iniciar Sesion Admin</h1>
